...
const codingIcons = {
    ...
    css:{
        icon:'/src/assets/coding icons/css3-original.svg',
    ...
    javascript:{
        icon:'/src/assets/coding icons/javascript-original.svg',
        iconText:'',
        simple: '/src/assets/coding icons/javascript-plain.svg',
        simpleText:'',
    },
    typescript:{
        icon:'/src/assets/coding icons/typescript-original.svg',
        iconText:'',
    ...
    figma:{
        icon:'/src/assets/coding icons/figma-original.svg',
        iconText:'',
        simple: '/src/assets/coding icons/figma-plain.svg',
        simpleText:'',
    },
    github:{
        icon:'/src/assets/coding icons/github-original.svg',
    ...
    react:{
        icon:'/src/assets/coding icons/react-original.svg',
    ...
    sass:{
        icon:'/src/assets/coding icons/sass-original.svg',
        iconText:'/src/assets/coding icons/sass-original.svg',
        simple: '',
        simpleText:'',
    },
    vscode:{
        icon:'/src/assets/coding icons/vscode-original.svg',
